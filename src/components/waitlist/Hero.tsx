  ...
  return (
    <section className="relative min-h-screen flex flex-col justify-center pt-36 md:pt-44 overflow-hidden">
      ...
      <div className="container relative z-10 mx-auto flex flex-col items-center text-center px-4">
        {/* Badge */}
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/5 border border-white/10 text-sm text-muted-foreground mb-8 animate-in fade-in slide-in-from-bottom-4 duration-700 backdrop-blur-sm hover:bg-white/10 transition-colors cursor-default">
        ...
        {/* Subheadline - More concrete as per analysis */}
        <p className="text-lg md:text-2xl text-muted-foreground/80 max-w-2xl mb-10 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-200 font-light leading-relaxed">
          The guided path for AI beginners. <br className="hidden md:block" />
          <span className="text-white font-normal">One offer. One build plan. One sales pack.</span>
        </p>
        ...
        <div className="animate-in fade-in slide-in-from-bottom-10 duration-700 delay-300 w-full flex flex-col items-center gap-6">
          ...
          {/* Social Proof Text - More specific */}
          <div className="flex items-center gap-4 text-xs text-muted-foreground/60">
            ...
            <p>Join 2,000+ builders getting their first win</p>
          </div>
        </div>
      </div>
    </section>
