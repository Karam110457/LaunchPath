...
export function AgentChatPanel({
  ...
  return (
    ...
    >
      ...
      {/* Floating input */}
      <div className={cn("absolute bottom-0 left-0 right-0 px-4 pb-5 pt-3 z-10", embedded && "bg-white/40 canvas-dark:bg-neutral-900/40 backdrop-blur-md rounded-b-[2rem]")}>
