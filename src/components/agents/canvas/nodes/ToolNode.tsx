  ...
  return (
    <div className="group relative flex flex-col items-center">
      ...
      <div className="mt-3 flex flex-col items-center pointer-events-none text-center max-w-[120px]">
        <h3 className="text-[13px] font-medium text-zinc-800 dark:text-zinc-200 leading-tight">
          {d.displayName}
        </h3>
        {!d.isEnabled ? (
          <p className="text-[10px] text-zinc-400 dark:text-zinc-500 mt-0.5 font-medium">Disabled</p>
        ) : (
