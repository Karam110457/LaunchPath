    ...
    <div className="group relative flex flex-col items-center">
      ...
      >
        ...
        <Handle
          ...
          className="!bg-white !w-4 !h-4 !border-[3px] !border-[#FF8C00] !rounded-full !top-[-10px] opacity-0 group-hover:opacity-100 transition-all z-20 hover:scale-125 shadow-sm cursor-crosshair"
        />
      </div>
