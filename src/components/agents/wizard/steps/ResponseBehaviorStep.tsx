  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        ...
        >
          <p className={`text-sm font-medium ${config.response_style === "concise" ? "text-[#FF8C00]" : "text-neutral-800 dark:text-neutral-200"}`}>
            Concise answers
          </p>
        ...
        >
          <p className={`text-sm font-medium ${config.response_style === "detailed" ? "text-[#FF8C00]" : "text-neutral-800 dark:text-neutral-200"}`}>
