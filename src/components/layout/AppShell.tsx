...
export function AppShell({ children, systems, user, agentCount, campaignCount }: AppShellProps) {
  return (
    <div className="min-h-screen bg-background flex">
      <Sidebar systems={systems} user={user} agentCount={agentCount} campaignCount={campaignCount} />
