    ...
    <div className="w-full max-w-3xl mx-auto">
      ...
      <div
        className={cn(
          ...
          embedded
            ? "bg-white/80 dark:bg-zinc-900/80 backdrop-blur-xl border-white/60 dark:border-zinc-700/60 shadow-[0_4px_16px_rgba(0,0,0,0.06)] py-3"
      ...
      >
        <textarea
          ...
          className={cn(
            ...
            embedded ? "text-zinc-800 dark:text-zinc-200 placeholder:text-zinc-400 dark:placeholder:text-zinc-500" : "text-foreground placeholder:text-muted-foreground/60"
          )}
      ...
      <p className={cn(
        ...
        embedded ? "text-zinc-500 dark:text-zinc-400 font-medium" : "text-muted-foreground/40"
      )}>
